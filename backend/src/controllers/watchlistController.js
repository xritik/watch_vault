...
const DEFAULT_DATA = [
  ...
  { title: 'The Boys', type: 'series', year: 2019, genre: 'Superhero, Satire', status: 'watching', rating: 5, emoji: '🦸', note: 'Homelander is the scariest villain on TV. This show says things no other show dares to. Butcher is my spirit animal.', added: Date.now() - 8.5e8 },
